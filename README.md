...
| **CatBoost**                                                                                                | An algorithm that uses gradient boosting on decision trees, with support for categorical variables.                                           | Supervised Learning    |
...
| Feature        | Details                                           |
|----------------|---------------------------------------------------|
| **Advantages** | - Easy to use<br>- Flexible<br>- Widely adopted   |
| **Limitations**| - Limited styling<br>- No cell merging            |
